 ...
 */
function assertExpressionCharacters(input: string): void {
...
function skipSpaces(input: string, pos: Pos): void {
...
function parseNumber(input: string, pos: Pos): number {
...
function parseFactor(input: string, pos: Pos): number {
  return parseNumber(input, pos);
}

function parseTerm(input: string, pos: Pos): number {
...
function parseExpr(input: string, pos: Pos): number {
